...
class ValidateMayaModelingRepairDisplayLayer(pyblish.api.Action):
...
class ValidateMayaModelingDisplaylayer(pyblish.api.ContextPlugin):
    """ Ensure no displays layers are present in the scene """

    order = pyblish.api.ValidatorOrder
    optional = True
    label = 'Display Layers'
    actions = [ValidateMayaModelingRepairDisplayLayer]
